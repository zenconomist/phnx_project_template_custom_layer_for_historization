defmodule PhnxProjectTemplateHistory.Accounts.UserFieldLog do
  ...
  def changeset(user_field_log, attrs) do
    user_field_log
    |> cast(attrs, [:row_id, :action, :field_name, :old_value, :new_value, :time_of_change, :changed_by, :deleted_at])
    |> validate_required([:row_id, :action, :field_name, :old_value, :new_value, :time_of_change, :changed_by])
  end
end
